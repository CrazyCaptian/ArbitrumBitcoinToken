  ...
  ApproveAndCallFallBack
{
  ...
  function _vaultOutputAmount(   uint256 reserveTokenAmount, address currencyToClaim ) public view returns (uint){
    ...
    //amount of output ETH to give to redeemer
  function _vaultOutputAmountETH(   uint256 reserveTokenAmount) public view returns (uint){

      uint256 internalVaultBalance = address(this).balance;
      ...
      return (internalVaultBalance * burnedTokenRatio) / 1000000000000000000;
  }
